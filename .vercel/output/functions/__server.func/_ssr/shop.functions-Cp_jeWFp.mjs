...
//#region node_modules/.nitro/vite/services/ssr/assets/shop.functions-Cp_jeWFp.js
...
var getProduct = createServerFn({ method: "GET" }).inputValidator((input) => objectType({ id: stringType().uuid() }).parse(input)).handler(createSsrRpc("efa9437fe30eb9ca917623d47c09585b7a1971a47b7699f7c2e726a597367236"));
//#endregion
