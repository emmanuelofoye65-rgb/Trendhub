...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-CYKLtJII.mjs";
require_react();
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BpZyUCH9.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BDz0ziob.mjs"),
		import("./start-7m5zYBPf.mjs"),
