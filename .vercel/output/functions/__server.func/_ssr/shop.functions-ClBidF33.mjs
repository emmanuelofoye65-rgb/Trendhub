...
//#region node_modules/.nitro/vite/services/ssr/assets/shop.functions-ClBidF33.js
...
var getProduct = createServerFn({ method: "GET" }).validator((input) => objectType({ id: stringType().uuid() }).parse(input)).handler(getProduct_createServerFn_handler, async ({ data }) => {
	const supabase = getPublicSupabase();
